...
Source9  : https://repo1.maven.org/maven2/org/apache/rat/apache-rat-project/0.11/apache-rat-project-0.11.pom
Source10  : https://repo1.maven.org/maven2/org/apache/rat/apache-rat-project/0.12/apache-rat-project-0.12.pom
Source11  : https://repo1.maven.org/maven2/org/apache/rat/apache-rat-tasks/0.11/apache-rat-tasks-0.11.jar
Source12  : https://repo1.maven.org/maven2/org/apache/rat/apache-rat-tasks/0.11/apache-rat-tasks-0.11.pom
Source13  : https://repo1.maven.org/maven2/org/apache/rat/apache-rat/0.11/apache-rat-0.11.jar
Source14  : https://repo1.maven.org/maven2/org/apache/rat/apache-rat/0.11/apache-rat-0.11.pom
...
cp %{SOURCE9} %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-project/0.11

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-project/0.12
cp %{SOURCE10} %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-project/0.12

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-tasks/0.11
cp %{SOURCE11} %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-tasks/0.11

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-tasks/0.11
cp %{SOURCE12} %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat-tasks/0.11

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat/0.11
cp %{SOURCE13} %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat/0.11

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat/0.11
cp %{SOURCE14} %{buildroot}/usr/share/java/.m2/repository/org/apache/rat/apache-rat/0.11
